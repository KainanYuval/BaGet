FROM devopspaper.jfrog.io/docker/mcr.microsoft.com/dotnet/aspnet:3.1 AS base
WORKDIR /app
EXPOSE 80

FROM devopspaper.jfrog.io/docker/mcr.microsoft.com/dotnet/sdk:3.1 AS build
WORKDIR /src
COPY /src .
